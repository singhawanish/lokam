...
class LocateOurServiceOutletPage extends StatefulWidget {
  const LocateOurServiceOutletPage({Key key, this.lat, this.long})
      : super(key: key);

  final double lat;
  final double long;
  @override
  _LocateOurServiceOutletState createState() => _LocateOurServiceOutletState();
}

class _LocateOurServiceOutletState extends State<LocateOurServiceOutletPage> {
                      ...
                      children: [
                        Center(
                          child: SizedBox(
                            ...
                            child: WebView(
                              initialUrl:
                                  'https://www.iocxtrapower.com/search-outlet.php',
