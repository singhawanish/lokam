...
import 'package:ioclcustomerconnect/views/menus/FindOpportunityHelper/opportunities_list_view.dart';
...
class ViewOthAssignedDetailPage extends StatefulWidget {
  const ViewOthAssignedDetailPage(
      {Key key, this.id, this.leadData, this.callback})
      : super(key: key);

  final String id;
  final OpportunitiesOthListData leadData;

  final VoidCallback callback;
  @override
  _ViewOthAssignedDetailState createState() => _ViewOthAssignedDetailState();
}

class _ViewOthAssignedDetailState extends State<ViewOthAssignedDetailPage> {
  ...
  final _leadFunctionValue = TextEditingController();
      ...
      if (response.statusCode == 200) {
        ...
        if (status) {
          ...
          data.forEach((element) {
            ...
            _leadFunctionValue.text = element['leadFunctionDesc'] as String;
  ...
  //  debugPrint('value::$widget.leadData.vehicles');
      ...
      if (!internet) {
        ...
        var response = await http.post(
            ...
            body: jsonEncode({
              ...
              "leadFunction": _leadFunctionValue.text,
