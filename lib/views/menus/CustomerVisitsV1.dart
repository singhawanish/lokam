...
class CustomerVisitsV1Page extends StatefulWidget {
  const CustomerVisitsV1Page({Key key, this.lat, this.long}) : super(key: key);

  final double lat;
  final double long;
  @override
  _CustomerVisitsV1State createState() => _CustomerVisitsV1State();
}

class _CustomerVisitsV1State extends State<CustomerVisitsV1Page> {
                          ...
                          child: Center(
                            child: Column(
                              children: <Widget>[
                                    ...
                                    DatePicker.showDateTimePicker(
                                      ...
                                      onConfirm: (date) {
                                        ...
                                        print(DateFormat('yyyyMMddHHmmss')
                                            .format(date));
                                        dueDate = DateFormat('yyyyMMddHHmmss')
                                            .format(date);
                                ...
                                displayDueDate != ""
                                    ? Text(
                                        'Picked Time of Visit: $displayDueDate',
                                      )
                                    : Container(),
                                Container(
                                  child: const SizedBox(
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText: 'XtraPower Customer ID',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText: 'XtraPower Customer Name',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
                                ...
                                Padding(
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _customerOfficeLocationFieldController,
                                      // inputFormatters: [ FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9]")),],
                                      decoration: InputDecoration(
                                          border: UnderlineInputBorder(
                                              borderSide: BorderSide(
                                  ...
                                  child: Theme(
                                    ...
                                    child: DropdownButtonFormField(
                                      style: TextStyle(
                                          ...
                                          fontSize: 16,
                                          color: Colors.black),
                                      items: consumerPumpStatusMap.map((map) {
                                        return DropdownMenuItem(
                                          child: Container(
                                            width: width * 0.7,
                                            child: Text(
                                      ...
                                      onChanged: (newVal) async {
                                        setState(() {
                                          _consumerPumpStatusDropdownSelection =
                                              newVal;
                                        });
                                      },
                                      // value: _industryDropdownSelection,
                                ...
                                Text(
                                  "*Customer's Average Monthly Volume",
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
                                ...
                                Text(
                                  "*Current Purchase from which OMCs",
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _currentPurchaseFromWhichOMCFieldController,
                                      // inputFormatters: [ FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9]")),],
                                      decoration: InputDecoration(
                                          border: UnderlineInputBorder(
                                              borderSide: BorderSide(
                                    ...
                                    data: ThemeData(
                                        primaryColor:
                                            CustomTheme.buildLightTheme()
                                                .primaryColor),
                                    child: TextFormField(
                                      controller: _iocShareFieldController,
                                      // inputFormatters: [ FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9]")),],
                                      decoration: InputDecoration(
                                          border: UnderlineInputBorder(
                                              borderSide: BorderSide(
                                ...
                                Text(
                                  '*Name of Customer Person Contacted',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _nameOfCustomerPersonContacted,
                                      // inputFormatters: [ FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9]")),],
                                      decoration: InputDecoration(
                                          border: UnderlineInputBorder(
                                              borderSide: BorderSide(
                                ...
                                Text(
                                  '*Mobile No. of Customer Person Contacted',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText:
                                              'Points of Discussion / Feedback / Requirement from Customer',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
                                    ...
                                    data: ThemeData(
                                        primaryColor:
                                            CustomTheme.buildLightTheme()
                                                .primaryColor),
                                    child: TextFormField(
                                      controller: _reasonForReductionInTxn,
                                      // inputFormatters: [ FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9]")),],
                                      decoration: InputDecoration(
                                          border: UnderlineInputBorder(
                                              borderSide: BorderSide(
                                          ...
                                          counterText: "",
                                          hintText:
                                              'Reason for Reduction in Txn / Sales Volume in IOC',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
                                      keyboardType: TextInputType.multiline,
                                      minLines: 1,
                                ...
                                Text(
                                  'If IB Customer (having CP) whether lead is to be communicated to IOC IB Officer',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
    ...
    if (_isFormValidated()) {
      ...
      if (!internet) {
        ...
        var response = await http.post(
            Uri.parse(BASE_URI +
                (_DSARole
                    ? '/DSA/captureCustomerVisit/v1'
                    : '/HMOFMO/captureCustomerVisit/v1')),
            headers: {
              "Accept": "application/json",
              "Authorization": jwt,
              'Content-type': 'application/json'
            ...
            body: jsonEncode({
              ...
              "customerName": _customerNameFieldController.text,
              "customerOfficeLocation":
                  _customerOfficeLocationFieldController.text,
              "customerAvgMonthlyVol":
                  _customerAvgMonthlyVolFieldController.text,
              "currentPurchaseFromWhichOMC":
                  _currentPurchaseFromWhichOMCFieldController.text,
              "iocShare": _iocShareFieldController.text,
              "consumerPumpStatus": _consumerPumpStatusDropdownSelection,
              "typeOfCustomer": _typeOfCustomerDropdownSelection,
              "nameOfCustomerPersonContacted":
                  _nameOfCustomerPersonContacted.text,
              "mobileOfCustomerPersonContacted":
                  _mobileOfCustomerPersonCpntacted.text,
              "reasonForReductionInTxn": _reasonForReductionInTxn.text,
