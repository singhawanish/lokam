...
import 'FindOpportunityHelper/oth_opportunities_list_view.dart';

class FindOpportunityOthPage extends StatefulWidget {
  final String period;
  final String type;
  final VoidCallback callback;

  FindOpportunityOthPage({Key key, this.period, this.type, this.callback})
      : super(key: key);

  @override
  _FindOpportunityOthPageState createState() => _FindOpportunityOthPageState();
}

class _FindOpportunityOthPageState extends State<FindOpportunityOthPage>
    with TickerProviderStateMixin {
  AnimationController animationController;
  List<OpportunitiesOthListData> opportunitiesList = [];
  List<OpportunitiesOthListData> searchOpportunitiesList = [];
  ...
  void getOpportunities() async {
      ...
      var response = await http.get(
        Uri.parse(BASE_URI +
            (_DSARole
                ...
                : '/HMOFMO/getCapturedOpportunitiesAssignedToOthers')),
        //   Uri.parse(BASE_URI +
        //   (_DSARole
        //   ? '/DSA/getCapturedOpportunities'
   ...
   //   debugPrint('response.statusCode :$response.statusCode ');
      if (response.statusCode == 200) {
        setState(() {
          List<OpportunitiesOthListData> std = [];
          Map<String, dynamic> map = jsonDecode(response.body);
          List<dynamic> data = map['data'];
          data.forEach((element) {
            std.add(OpportunitiesOthListData(
                                  ...
                                  ? RefreshIndicator(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return OpportunitiesOthListView(
