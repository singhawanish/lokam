...
class MarketIntelligencePhotosPage extends StatefulWidget {
  const MarketIntelligencePhotosPage({
    Key key,
    this.ID,
  }) : super(key: key);
  @override
  _MarketIntelligencePhotosState createState() =>
      _MarketIntelligencePhotosState();
  final String ID;
}

class _MarketIntelligencePhotosState extends State<MarketIntelligencePhotosPage>
  ...
  Future<void> getDropdownValues() async {
    ...
    if (!internet) {
      ...
      var response = await http.post(
          Uri.parse(BASE_URI +
              (_DSARole
                  ? '/DSA/getMarketIntelligenceDetailsPhotos'
                  : '/HMOFMO/getMarketIntelligenceDetailsPhotos')),
          headers: {
