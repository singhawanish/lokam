...
class CaptureCampaignDetailsPage extends StatefulWidget {
  const CaptureCampaignDetailsPage({Key key, this.lat, this.long})
      : super(key: key);

  final double lat;
  final double long;
  @override
  _CaptureCampaignDetailsState createState() => _CaptureCampaignDetailsState();
}

class _CaptureCampaignDetailsState extends State<CaptureCampaignDetailsPage> {
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText: 'Cost Involved in Campaign',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
