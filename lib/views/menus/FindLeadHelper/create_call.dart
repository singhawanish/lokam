...
class CreateCallPage extends StatefulWidget {
  const CreateCallPage({Key key, this.id, this.lat, this.long})
      : super(key: key);
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                ElevatedButton(
                                      ...
                                      onConfirm: (date) {
                                        ...
                                        callStartDate =
                                            DateFormat('yyyyMMddHHmmss')
                                                .format(date);
                                        displayCallStartDate = date.toString();
                                        setState(() {});
                                      },
                                  ...
                                  child: Text(
                                    'Pick Call Start Date',
                                  ),
                                ),
                                displayCallStartDate != ""
                                    ? Text(
                                        'Picked Call Start Date: $displayCallStartDate',
                                      )
                                    : Container(),
                                Container(
                                  child: const SizedBox(
    ...
    if (_isFormValidated()) {
      ...
      if (!internet) {
        ...
        var response = await http.post(
            Uri.parse(BASE_URI +
                (_DSARole ? '/DSA/createCall' : '/HMOFMO/createCall')),
            headers: {
                ...
                .showSnackBar(
                  SnackBar(
                    content: WillPopScope(
                      ...
                      child: Text('Call Creation Failed'),
                    ),
                  ),
                )
                .closed
