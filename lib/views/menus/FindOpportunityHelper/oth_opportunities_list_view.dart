...
import '../ViewAssignedDetail.dart';
import '../ViewOthAssignedDetail.dart';
import 'convert_to_account.dart';
import 'package:http/http.dart' as http;

class OpportunitiesOthListView extends StatefulWidget {
  const OpportunitiesOthListView({
    Key key,
  ...
  final OpportunitiesOthListData opportunityData;
  ...
  final String type;
  @override
  _OpportunitiesOthListViewState createState() =>
      _OpportunitiesOthListViewState();
}

class OpportunitiesOthListData {
  OpportunitiesOthListData(
      {this.id,
      this.leadOwner,
      this.companyName,
...
class _OpportunitiesOthListViewState extends State<OpportunitiesOthListView> {
  String jwt;
  String name;
