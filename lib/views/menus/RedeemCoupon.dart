...
class RedeemCouponPage extends StatefulWidget {
  const RedeemCouponPage({Key key, this.lat, this.long}) : super(key: key);
...
class _RedeemCouponState extends State<RedeemCouponPage> {
  ...
  final _couponCodeFieldController = TextEditingController();
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      validator: (value) => value.length == 0
                                          ? 'Enter Proper Coupon Code'
                                          : null,
                                      controller: _couponCodeFieldController,
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText:
                                              'Customer Mobile Number for OTP',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
  ...
  _onSubmitLoginButton() async {
    ...
    if (_isFormValidated()) {
      ...
      if (!internet) {
        ...
        var response =
            await http.post(Uri.parse(BASE_URI + '/DHABA/redeemCoupon'),
                headers: {
                ...
                body: jsonEncode({
                  "couponCode": _couponCodeFieldController.text,
    ...
    if (!internet) {
      ...
      if (rsa.statusCode == 200) {
        ...
        var res = await http.post(
          Uri.parse(BASE_URI + '/DHABA/userGetOTP'),
          body: body,
