...
class CutomerMeetMiniDetailsPage extends StatefulWidget {
  const CutomerMeetMiniDetailsPage({Key key, this.lat, this.long})
      : super(key: key);

  final double lat;
  final double long;
  @override
  _CutomerMeetMiniDetailsState createState() => _CutomerMeetMiniDetailsState();
}

class _CutomerMeetMiniDetailsState extends State<CutomerMeetMiniDetailsPage> {
                          ...
                          child: Center(
                            child: Column(
                              children: <Widget>[
                                ...
                                Text(
                                  '*Name of Venue / Hotel / RO / Customer Premises',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 18,
                                  ),
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          counterText: "",
                                          hintText:
                                              'Venue/Hotel/RO/Customer Premises Name',
                                          hintStyle: TextStyle(
                                              fontStyle: FontStyle.italic)),
    ...
    if (_isFormValidated()) {
      ...
      if (!internet) {
        ...
        var response = await http.post(
            Uri.parse(BASE_URI +
                (_DSARole
                    ? '/DSA/captureCustomerMeetMini'
                    : '/HMOFMO/captureCustomerMeetMini')),
            headers: {
              "Accept": "application/json",
              "Authorization": jwt,
              'Content-type': 'application/json'
            ...
            body: jsonEncode({
              "organizingHub": _hubDropdownSelection,
