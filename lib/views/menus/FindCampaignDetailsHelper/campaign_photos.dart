...
class CampaignPhotosPage extends StatefulWidget {
  const CampaignPhotosPage({
    Key key,
    this.ID,
  }) : super(key: key);
  @override
  _CampaignPhotosState createState() => _CampaignPhotosState();
  final String ID;
}

class _CampaignPhotosState extends State<CampaignPhotosPage>
  ...
  Future<void> getDropdownValues() async {
    ...
    if (!internet) {
      ...
      var response = await http.post(
          Uri.parse(BASE_URI +
              (_DSARole
                  ? '/DSA/getCampaignDetailsPhotos'
                  : '/HMOFMO/getCampaignDetailsPhotos')),
          headers: {
