...
class IssueCouponBulkPage extends StatefulWidget {
  const IssueCouponBulkPage({Key key, this.lat, this.long}) : super(key: key);

  final double lat;
  final double long;
  @override
  _IssueCouponBulkState createState() => _IssueCouponBulkState();
}

class _IssueCouponBulkState extends State<IssueCouponBulkPage> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final formKey = GlobalKey<FormState>();
  final _noOfCouponsFieldController = TextEditingController();
                                  ...
                                  child: Theme(
                                    ...
                                    child: TextFormField(
                                      validator: (value) => value.length == 0
                                          ? 'Enter Proper Numeric Value'
                                          : null,
                                      controller: _noOfCouponsFieldController,
      ...
      if (!internet) {
        ...
        var response = await http.post(
            ...
            body: jsonEncode({
              ...
              "count": _noOfCouponsFieldController.text,
