...
class ViewAssignedDetailPage extends StatefulWidget {
  const ViewAssignedDetailPage({Key key, this.id, this.leadData, this.callback})
      : super(key: key);

  final String id;
  final OpportunitiesListData leadData;

  final VoidCallback callback;
  @override
  _ViewAssignedDetailState createState() => _ViewAssignedDetailState();
}

class _ViewAssignedDetailState extends State<ViewAssignedDetailPage> {
